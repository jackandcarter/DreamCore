          ...
          <section class="rounded-3xl gradient-border bg-gray-900/70 p-6 shadow-inner shadow-rose-900/30">
            ...
            <div id="classicPanel" class="mt-6 space-y-5 hidden">
              <div id="classicLinkedSummary" class="hidden rounded-2xl gradient-border bg-gray-900/60 p-4">
                ...
                <p class="text-sm text-rose-100/80">Manage characters and resets from the roster dashboard. Portal password updates keep this login synced, and your Wrath 3.3.5 client is ready whenever you are.</p>
                <div class="mt-3 flex flex-col gap-2 sm:flex-row">
                  <a class="inline-flex items-center justify-center rounded-2xl border border-rose-400/50 px-4 py-2 text-sm font-semibold text-rose-50 hover:text-white hover:border-rose-200 hover:bg-rose-500/20 focus:outline-none focus:ring-2 focus:ring-rose-300" href="/characters">Open roster</a>
                  <a
                    class="inline-flex items-center justify-center rounded-2xl bg-rose-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-rose-900/50 transition hover:bg-rose-400 focus:outline-none focus:ring-2 focus:ring-rose-300"
                    href="${CONFIG.CLASSIC_CLIENT_DOWNLOAD_URL}"
                    target="_blank"
                    rel="noopener noreferrer"
                  >Download Classic Client</a>
                </div>
              </div>
              <form id="classicLinkForm" class="space-y-4">
                <p class="text-sm text-rose-100/85">You're already verified through your portal login. Create a DreamCore Classic game account below—just choose a Classic username and password and we'll provision the Wrath credentials with your portal email. No extra email verification needed.</p>
                <div>
